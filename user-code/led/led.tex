...
{\tt https://spoken-tutorial.org/}. In case, you have an RGB LED and you want to try connecting it with \arduino\ on a breadboard,  
please refer to \figref{fig:ard-rgb-bread}. Also, you should refer to the sixth tutorial titled Arduino with Tricolor LED and 
Push button on {\tt https://spoken-tutorial.org/}. 
...
In \figref{fig:ard-rgb-bread}, there is an RGB LED with four legs. 
